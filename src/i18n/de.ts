  ...
  pages: {
    unternehmen: {
      ...
      blocks: [
        ...
        { heading: 'Unser Anspruch', body: 'Vor der ersten Lieferung klären wir Anwendung und Rezeptur. Basalt-Füller, Diabas-Füller und Mikrodiorit-Füller unterscheiden sich in Kornverteilung, Dichte und Farbe; in der Betonproduktion wirkt sich das auf Wasseranspruch, Verarbeitbarkeit und Optik aus. Jedem Werk ist ein fester Ansprechpartner zugeordnet, der die Rezeptur, die Abrufmengen und den Lieferrhythmus kennt. Liefertermine werden verbindlich bestätigt und auf Ihren Produktionsplan abgestimmt. Bei laufenden Lieferungen bleibt die vereinbarte Spezifikation die Grundlage, Abweichungen werden vor der Verladung besprochen. Für Sonderqualitäten, Teilmengen und kurzfristige Termine suchen wir eine Lösung, solange Beschaffung und Logistik sie zulassen.' },
      ],
      inhaber: {
        heading: 'Der Inhaber',
        ...
        body: 'Über 40 Jahre in einem Markt zu bestehen, den Preise, Frachtraten und Lieferketten in Bewegung halten, ist eine Frage der Beziehungen. Daniel Breitbach hat Breitbach von einem regionalen Baustoffhandel zu einem international beschaffenden Handelshaus entwickelt. Er gibt die Richtung vor: langfristige Lieferbeziehungen, ein Sortiment, das den Anforderungen der Beton- und Zementindustrie folgt, und der Schritt in neue Beschaffungsmärkte, wo er den Kunden einen Vorteil bringt. Das operative Geschäft trägt das Team.',
      },
    },
