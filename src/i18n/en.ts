  ...
  pages: {
    unternehmen: {
      ...
      blocks: [
        ...
        { heading: 'Our approach', body: 'Before the first delivery we clarify the application and the mix design. Basalt filler, diabase filler and microdiorite filler differ in particle size distribution, density and colour; in concrete production this affects water demand, workability and appearance. You deal with the same contact throughout, from quotation through call-off to invoice: Daniel Breitbach. Delivery dates are confirmed as binding and aligned with your production schedule. On running deliveries the agreed specification remains the basis, and any deviation is discussed before loading. In an owner-run firm decisions are made quickly, without long internal chains, including on special gradings, part quantities and short-notice dates.' },
      ],
      inhaber: {
        heading: 'The owner',
        ...
        body: 'Daniel Breitbach runs the company as its owner. Enquiries, quotations and questions about mix design go through him personally. Dates, specifications and prices are agreed directly with him. He can be reached on 02652 6326 and at info@baustoffe-breitbach.com.',
      },
    },
